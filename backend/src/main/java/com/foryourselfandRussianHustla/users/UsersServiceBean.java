...
public class UsersServiceBean implements UsersService {
	...
	private static final String PASSWORD_SALT_ALPHABET = "0123456789abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ`~!@#$%^&*()-+[]{}\\|,.<>/?";
	...
	public UserEntity createUser(@NotNull @Size(min = 2) @NotBlank String username, @NotNull @NotBlank String password) {
		...
		try {
			UserEntity entity = new UserEntity(null, username, hash, salt);
	...
	private String generateSalt() {
		char[] saltChars = new char[PASSWORD_SALT_LENGTH];
